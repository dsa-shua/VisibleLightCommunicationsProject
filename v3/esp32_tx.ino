  ...
  if (Serial.available()){
    ...
    switch(incomingByte){  
      ...
      if(!ACK_REC) {
        ...
        // Send one more
        delay(500); // just wait 0.5 sec 
        Serial.println("  Resending 1 more time");
        TX_Commit(RD_BUFF, RS_BUFF, DT_BUFF, OP_BUFF);
        ...
        if(!ACK_REC) Serial.println("   welp... it really was blocked.");
